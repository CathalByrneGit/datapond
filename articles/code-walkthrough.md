...
db_write <- function(data, schema = "main", table,
                     ...
                     col_types = NULL,       # Explicit column types
  ...
  # Build column definitions with explicit types where specified
  ...
  # Set partitioning (hive + bucket)
  # Set clustering (sort_by)
  # Insert data (with optional inlining)
...
- `col_types` allows explicit type specification (e.g., `DECIMAL(12,2)`,
  `BIGINT`)
