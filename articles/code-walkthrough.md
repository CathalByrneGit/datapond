...
Documentation metadata is stored in a `_metadata` schema within the
DuckLake catalog:
...
Native SQL COMMENT stored in catalog (distinct from
...
# Column comment
db_comment(table = "users", column = "email", comment = "Must be unique")
