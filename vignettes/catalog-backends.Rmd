...
To use Quack as a catalog backend, you need a running DuckDB server. A minimal server:
...
For production deployments (systemd, Docker, nginx, cloud), see `vignette("quack-server")`.
