...
[Quack](https://duckdb.org/2026/05/12/quack-remote-protocol) is DuckDB's new client-server protocol, released with DuckDB v1.5.2:
...
For most users starting out, **SQLite is the recommended default** - it's simple, requires no infrastructure, and handles typical team usage patterns well.
