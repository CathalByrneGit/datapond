...
- **Preview** - View sample rows from any table (select from tree on
  left)
- **Metadata** - See documentation, owner, tags, and column descriptions
- **Search** - Find tables by name, description, owner, or tags; search
  columns across all tables
- **Dictionary** - Generate and export a full data dictionary as CSV
- **Access Control** - Guidance on folder-based permissions with
  DuckLake
